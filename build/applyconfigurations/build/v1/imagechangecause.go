...
type ImageChangeCauseApplyConfiguration struct {
	...
	FromRef *v1.ObjectReferenceApplyConfiguration `json:"fromRef,omitempty"`
}
...
func (b *ImageChangeCauseApplyConfiguration) WithFromRef(value *v1.ObjectReferenceApplyConfiguration) *ImageChangeCauseApplyConfiguration {
	b.FromRef = value
	return b
}
