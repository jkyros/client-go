...
func (b *MachineConfigPoolStatusConfigurationApplyConfiguration) WithSource(values ...v1.ObjectReference) *MachineConfigPoolStatusConfigurationApplyConfiguration {
	for i := range values {
