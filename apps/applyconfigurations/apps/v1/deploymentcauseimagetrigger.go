...
func (b *DeploymentCauseImageTriggerApplyConfiguration) WithFrom(value *v1.ObjectReferenceApplyConfiguration) *DeploymentCauseImageTriggerApplyConfiguration {
	b.From = value
	return b
}
